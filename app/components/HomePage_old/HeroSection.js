                ...
                >
                  <div className="title-heading text-left">
                    <h1
                      ...
                      className="lead mb-3 mr-5"
                      style={{ fontSize: '1.45rem' }}
                    >
                      <b>BÄSTA JULKLAPPEN</b> till farmor/farfar och
                      mormor/morfar
                    </h1>
                    <h1 className="blue-text mr-5" style={{ color: '#227fcd' }}>
                      <b>Låt ditt barn få skapa sitt eget konstverk</b>
                    </h1>
                    <img
                      src={play}
                      onClick={this.openModal}
