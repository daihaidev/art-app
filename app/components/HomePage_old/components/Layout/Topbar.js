...
class Topbar extends Component {
  ...
  componentDidMount() {
    ...
    if (window.location.pathname === "/cookie-consent") {
      console.log("on cookie page");
  ...
  openBlock = level2_id => {
    let tmpLinks = this.state.navLinks;
...
dangerouslySetInnerHTML={{
            ...
            <div className="buy-button">
                <a href="#" target="_blank" rel="noopener noreferrer" id="buyButton" className="btn btn-primary">Skapa konto</a>
              </div>
                                      ...
                                      <ul className={childArray.isOpenNestedSubMenu ? "submenu open" : "submenu"}>
                                        {
                                          ...
                                          // nested sub menu item - Level 3
                                            <li key={nestedKey}><Link
to={nestedChildArray.link} spy
                                              smooth
                                              offset={-70}
...
to={navLink.link} spy
              ...
              <div className="buy-menu-btn d-none">
                  <a href="#" rel="noopener noreferrer" className="btn btn-primary">Skapa konto</a>
                </div>
              </div>
            </Container>
        </header>
