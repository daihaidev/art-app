    ...
    return (
      <React.Fragment>
        <section id="fungerar" className="section mb-0">
            <Container>
            {/* section title */}
            <SectionTitle isLeft title="Köpvillkor DiggiArt" desc="" />
            <h3>Företagsinformation</h3>
              <p>Juridiskt namn: Digitalprint i Österåker AB<br />
              <br />
              Org. nummer: 556835-7866
              <br />
              Postadress: Box 367, 18424 Åkersberga, Sverige
              <br />
              Gatuadress: Stationsgränd 24, 18450 Åkersberga, Sverige
              <br />
              Telefon: <a href="tel:08-540 666 40">08-540 666 40</a>
              <br />
              E-post: <a href="mailto:info@diggiart.com">info@diggiart.com</a>
              <h4>Allmänt</h4>
            ...
            <p>Leveranstider 4-5 dagar gäller för leveranser inom Sverige.</p>
              ...
              <h4>Ångerrätt</h4>
              <p>Enligt Lag (2005:59) om distansavtal och avtal utanför affärslokaler gäller ej ångerrätten när köpet avser en vara som har tillverkats enligt konsumentens anvisningar eller som annars har fått en tydlig personlig prägel. När din beställning är skickad från oss avsäger vi oss därför ångerrätten, eftersom samtliga våra produkter produceras individuellt efter kundens önskemål.</p>
              <h4>Reklamation</h4>
              ...
              <h4>Tvist</h4>
            Vår ambition är alltid att lösa eventuella problem tillsammans med
            våra kunder. Om du har problem med en produkt som du har köpt från
            DiggiArt och för det fall att du inte har lyckats lösa tvisten
            tillsammans med oss, kan du lämna in ett klagomål till: Allmänna
            Reklamationsnämnden, <a href="www.arn.se">www.arn.se</a>
            <br />
            Box 174
            <br />
            101 23 Stockholm
