              ...
              <Col md="6" className="mt-4 mt-sm-0 pt-2 pt-sm-0">
                <div className="ml-md-4">
                  <p style={{fontSize:"1.2rem"}}><b> DiggiArt är lika enkelt som roligt för ditt barn</b> att på egen hand
                    på egen hand kunna måla en tavla. Antingen helt på fri hand
                    eller i kombination med färdiga bilder som kan färgläggas. I
                    DiggiArt finns även möjligheten att ”Ta ett foto” eller
                    ”Ladda upp bild”.{' '}
                    <b>En kreativitet utan gränser för ditt barn</b>.{' '}
                  <p  style={{fontSize:"1.2rem"}}>
                    <b>Helt säkert är - att det blir en unik tavla</b>. Fin att sätta på väggen i
                    sätta på väggen i lekrummet eller varför inte ge bort den i
                    present till någon som står barnet nära och värderar tavlan
                    högre än en Picasso målning.
                </div>
              </Col>
            </Row>
          </Container>
