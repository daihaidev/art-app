...
import Julgran from "../../../assets/shapeImages/Jul_julgran.svg"
import Tomte from "../../../assets/shapeImages/Jul_tomte.svg"
import Paket from "../../../assets/shapeImages/Jul_paket.svg"
import Snogubbe from "../../../assets/shapeImages/Jul_snogubbe.svg"

export const ClipImgList = [
  { src: Julgran, label: 'Julgran' },
  { src: Tomte, label: 'Tomte' },
  { src: Paket, label: 'Paket' },
  { src: Snogubbe, label: 'Snogubbe' },
...
const ImagePicker = ({ imagePicker = false, addAnimal, drawSelectedShape }) => (
  <div className={`Sidebar ${imagePicker ? "Sidebar--opened-my" : null}`}>
